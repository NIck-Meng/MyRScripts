...
# 在使用函数处理不完整的数据时，可以查阅该函数的帮助文档，检查其处理不完整数据的方法
...
# is.datatype(),as.datatype()分别为类型判断函数和类型转换函数
...
# 增加列
# 可以使用merge()函数将两个数据框通过一个或多个变量连接起来，
